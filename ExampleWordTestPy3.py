...
print("Rowling Freq of {} per 100,000 Words: ".format(TestWord)+str(int(RWord)))
print("Collins Freq of {} per 100,000 Words: ".format(TestWord)+str(int(CWord)))
print("Galbraith Freq of {} per 100,000 Words: ".format(TestWord)+str(int(GWord)))